          ...
          <div class="relative flex h-16 justify-between">
            ...
            <div class="
              ...
              <div class="flex flex-shrink-0 items-center">
                <h4 class="block h-6 w-auto lg:hidden">Roger Snorton</h4>
                <h4 class="hidden h-6 w-auto lg:block">Roger Snorton</h4>
              </div>
              <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                {/* <!-- Current: "border-indigo-500 text-gray-900", Default: "border-transparent text-gray-
                500 hover:border-gray-300 hover:text-gray-700" --> */}
                <a href="#" class="
                      inline-flex
                      items-center
          ...
          <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            ...
            3EAEAEA] h-auto my-6 py-8 rounded-lg border-4">
              ...
              <div id="content" class="prose lg:prose-xl px-2">
                <h1 class="text-center text-gray-800 text-4xl capitalize font-medium">Roger Snorton</h1>
                <small class="text-center block text-md text-gray-800">Human Resource Manager</small>
                <p class="text-justify text-lg text-gray-800">My name is Roger Snorton, HR Manager of the Corporate Resource Specialists International.</p>
              </div>
            </div>
            ...
            <div id="work" class="bg-[#B2B2B2] h-auto my-6 py-8 rounded-lg border-4">
              ...
              <details class="px-6 py-4">
                <summary class="font-bold text-2xl text-gray-800">Mega Global</summary>
              ...
              <details class="px-6 py-4">
                <summary class="font-bold text-2xl text-gray-800">HR Component</summary>
                <p>Epcot is a theme park at Walt Disney World Resort featuring exciting attractions, international
                  pavilions, award-winning fireworks and seasonal special events.</p>
              </details>
